...
<head>
    ...
    <title>OASISFLOW - Customer Dashboard</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <div class="nav-item" data-page="order-now">
                    <i>📦</i>
                    <span>Order Now</span>
                </div>
                ...
                <div class="nav-item" data-page="my-balance">
                    <i>🏷️</i>
                    <span>My Balance</span>
                </div>
                <div class="nav-item" data-page="track-my-delivery">
                    <i>🎫</i>
                    <span>Track My Delivery</span>
                </div>
                <div class="nav-item" data-page="bottle-returns">
                    <i>⭐</i>
